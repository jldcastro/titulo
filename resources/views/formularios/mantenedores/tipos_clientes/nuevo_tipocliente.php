<div class="row">
    <div class="col-md-6 col-md-offset-3">
            <div class="box-header with-border">
                <h3 class="box-title">Ingresar Nuevo Tipo Cliente</h3>
            </div><!-- /.box-header -->

            <div id="notificacion"></div>

            <form  id="nuevo_tipocliente"  method="post"  action="crear_tipocliente" class="form-horizontal formulario" role="form">
